...
import {colRowToCell} from './grid.js';
...
function getSurroundings(gridWidth, grid, x, y) {
  return [
    /* UP */ grid[colRowToCell(gridWidth, x, y - 1)] === Cell.FLOOR,
    /* RT */ grid[colRowToCell(gridWidth, x + 1, y)] === Cell.FLOOR,
    /* DN */ grid[colRowToCell(gridWidth, x, y + 1)] === Cell.FLOOR,
    /* LT */ grid[colRowToCell(gridWidth, x - 1, y)] === Cell.FLOOR,
  ];
}
